    ...
    <div className="text-center">
      ...
      <div className="bg-white rounded-xl shadow-md border border-gray-200 p-6 md:p-8 text-left">
        ...
        <select
          ...
          className="w-full mb-5 p-3 rounded-lg border-2 border-gray-200 text-navy-900 bg-white focus:outline-none focus:ring-2 focus:ring-lava-400 focus:border-lava-400 hover:border-gray-300 transition-colors appearance-none cursor-pointer"
        >
        ...
        <select
          ...
          disabled={!borough}
          className="w-full mb-8 p-3 rounded-lg border-2 border-gray-200 text-navy-900 bg-white focus:outline-none focus:ring-2 focus:ring-lava-400 focus:border-lava-400 hover:border-gray-300 transition-colors appearance-none cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:border-gray-200"
        >
          <option value="">
